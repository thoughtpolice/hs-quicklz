...
// Slight modifications by Austin Seipp 2011 for use in
// haskell library binding: specify compression level statically,
// disable streaming mode, turn on memory safety when building for
// tests, etc
